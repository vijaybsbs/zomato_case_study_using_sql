# zomato_case_study_using_sql
Zomato Restaurant Data Analysis using SQL and Python – EDA, customer engagement, pricing, online delivery, restaurant segmentation and business insights.
Project Overview
